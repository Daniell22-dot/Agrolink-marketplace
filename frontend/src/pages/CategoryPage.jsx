...
const CATEGORY_DATA = {
  'farm-inputs': {
    ...
    subcategories: [
      ...
      { name: 'Sprayers & Pumps', slug: 'farm-inputs', image: '/images/Fertilizer.jpg', count: 28 },
      { name: 'Storage Bags', slug: 'farm-inputs', image: '/images/Shopping bag.jpg', count: 19 },
      { name: 'Post-Harvest Equipment', slug: 'farm-inputs', image: '/images/Maize1.jpg', count: 23 },
      { name: 'Greenhouse Materials', slug: 'farm-inputs', image: '/images/Variant of seeds.jpg', count: 17 },
    ],
  },
  seeds: {
    name: 'Seeds',
    ...
    subcategories: [
      ...
      { name: 'Vegetable Seeds', slug: 'seeds', image: '/images/Chillie(Pilipili).jpg', count: 56 },
      ...
      { name: 'Legume Seeds', slug: 'seeds', image: '/images/Beans.jpg', count: 22 },
  ...
  tools: {
    ...
    subcategories: [
      ...
      { name: 'Pruning Tools', slug: 'tools', image: '/images/Chillie(Pilipili).jpg', count: 18 },
  ...
  baskets: {
    ...
    subcategories: [
      ...
      { name: 'Plastic Crates', slug: 'baskets', image: '/images/Chillie(Pilipili).jpg', count: 19 },
      { name: 'Grain Bins', slug: 'baskets', image: '/images/Drip Irrigation.jpg', count: 12 },
      { name: 'Cold Storage', slug: 'baskets', image: '/images/Sprinkler.jpg', count: 8 },
      { name: 'Drying Racks', slug: 'baskets', image: '/images/Fertilizer.jpg', count: 15 },
    ],
  },
  fertilizers: {
    name: 'Fertilizers',
    ...
    subcategories: [
      ...
      { name: 'Organic Compost', slug: 'fertilizers', image: '/images/Variant of seeds.jpg', count: 27 },
      { name: 'Urea & DAP', slug: 'fertilizers', image: '/images/Maize1.jpg', count: 21 },
      { name: 'Foliar Feeds', slug: 'fertilizers', image: '/images/Fertilizer.jpg', count: 15 },
      { name: 'Soil Amendments', slug: 'fertilizers', image: '/images/Chillie(Pilipili).jpg', count: 12 },
      { name: 'Micronutrients', slug: 'fertilizers', image: '/images/Drip Irrigation.jpg', count: 9 },
    ],
  },
};
...
const SAMPLE_PRODUCTS = {
  ...
  seeds: [
    ...
    { id: 's2', title: 'Tomato Seeds (100g Pack)', price: 280, originalPrice: 400, category: 'seeds', county: 'Kiambu', rating: 4.7, images: ['/images/Chillie(Pilipili).jpg'], farmer: { fullName: 'Central Seed Bank' } },
    { id: 's3', title: 'Sukuma Wiki Seeds (500g)', price: 180, originalPrice: 250, category: 'seeds', county: 'Kisii', rating: 4.9, images: ['/images/Carrots.jpg'], farmer: { fullName: 'Kisii Green Farms' } },
  ...
  tools: [
    ...
    { id: 't2', title: 'Heavy Duty Jembe (Full Size)', price: 850, originalPrice: 1100, category: 'tools', county: 'Machakos', rating: 4.8, images: ['/images/Panga.jpeg'], farmer: { fullName: 'Ukambani Hardware' } },
    { id: 't3', title: 'Panga / Machete (18 inch)', price: 650, originalPrice: 900, category: 'tools', county: 'Kakamega', rating: 4.7, images: ['/images/Shovel and Spade.jpeg'], farmer: { fullName: 'Western Tools Co-op' } },
  ...
  baskets: [
    ...
    { id: 'b3', title: 'Plastic Harvest Crate (60L)', price: 450, originalPrice: 600, category: 'baskets', county: 'Nairobi', rating: 4.7, images: ['/images/Chillie(Pilipili).jpg'], farmer: { fullName: 'Nairobi Agri Mart' } },
  ...
  fertilizers: [
    ...
    { id: 'f2', title: 'Organic Compost Fertilizer (25kg)', price: 850, originalPrice: 1200, category: 'fertilizers', county: 'Kiambu', rating: 4.9, images: ['/images/Variant of seeds.jpg'], farmer: { fullName: 'Green Valley Organics' } },
